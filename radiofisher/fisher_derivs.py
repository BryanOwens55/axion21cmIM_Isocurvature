...
def cached_camb_output(p, cachefile, cosmo,
    ...
    p2 = p.copy()
    p2['output_root'] = root + fname + '_iso'
    camb.camb_params("%s_iso.ini" % fname, **p2, axion_isocurvature='T')
    output = camb.run_camb("%s.ini" % fname, camb_exec_dir=CAMB_EXEC, params_fname2="%s_iso.ini" % fname)
    #output1 = camb.run_camb("%s_iso.ini" % fname, camb_exec_dir=CAMB_EXEC)

    #cosmo['components_for_P']
    ...
    powerspec_dic2 = calc_PS_from_camb_output(path_to_files=path_to_files,
    ...
    #powerspec_dic['PS_total'] = (1-alpha) * powerspec_dic['PS_total'] + alpha * powerspec_dic2['PS_total']
    #powerspec_dic['PS_total'] = (1-alpha) * powerspec_dic['PS_total'] + alpha * powerspec_dic2['PS_total']
    #powerspec_dic['growth_rate'] = (1-alpha) * powerspec_dic['growth_rate'] + alpha * powerspec_dic2['growth_rate']
